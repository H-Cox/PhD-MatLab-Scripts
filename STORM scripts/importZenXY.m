...
%   POSTMIXZENNOSHIFT2 = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   POSTMIXZENNOSHIFT2 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   PostmixZenNoShift2 = importfile('PostmixZenNoShift2.txt', 1, 1143397);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/10/03 10:09:15
