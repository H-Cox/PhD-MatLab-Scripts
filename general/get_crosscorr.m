...
N1 = sum(sum(I1.*mask));  % number of particles within mask
N2 = sum(sum(I2.*mask)); 
...
fI1 = fft2(I1.*mask,L1, L2);
fI2 = fft2(I2.*mask,L1, L2);
cfI2 = conj(fI2);

G1 = A^2/(N1*N2)*real(fftshift(ifft2(abs(fI1.*cfI2))))./NP; % 2D G(r) with proper normalization
