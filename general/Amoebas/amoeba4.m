...
function bestfit=amoeba4(funk,xguess,iterations)
...
f=zeros(1,N+1);
for i=1:N+1
 f(i)=feval(funk,feet(i,1),feet(i,2),feet(i,3),feet(i,4));
end
...
f(j) = feval(funk,feet(j,1),feet(j,2),feet(j,3),feet(j,4)); %evaluate funk
%end reflection
%---------------------------------------------------------------------
