...
function bestfit=amoeba6(funk,xguess,iterations)
...
f=zeros(1,N+1);
for i=1:N+1
 f(i)=feval(funk,feet(i,1),feet(i,2),feet(i,3),feet(i,4),feet(i,5),feet(i,6));
end
...
f(j) = feval(funk,feet(j,1),feet(j,2),feet(j,3),feet(j,4),feet(j,5),feet(j,6)); %evaluate funk
%end reflection
%---------------------------------------------------------------------
